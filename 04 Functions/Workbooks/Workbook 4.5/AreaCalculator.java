public class AreaCalculator {
     ...
     * 
     * Inside the function: 
     *  1. If the side is 0 or negative, prints "Error: impossible" and terminates the java program.
     *  2. Calculates the area of the square. A = side²
     */
    public static double areaSquare(double side) {
        if (side <= 0) {
            System.out.println("Error: Side needs to be above 0");
            System.exit(0);
        }
     ...
     * 
     * Inside the function: 
     *  1. If the length OR width is 0 or negative, prints "Error: impossible" and terminates the program.
     *  2. Calculates the area of the rectangle. A = length * width
     */
    public static double areaRectangle(double length, double width) {
         if (length <= 0 || width <= 0) {
            System.out.println("Error: Length and width need to be above 0");
            System.exit(0);
        }
    ...
    public static double areaTriangle(double base, double height) {
        if (base <= 0 || height <= 0) {
            System.out.println("Error: Base and height need to be above 0");
            System.exit(0);
        }
     ...
     * 
     * Inside the function: 
     *  1. If the radius is 0 or negative, prints "Error: impossible" and terminates the program.
